...
TELEMETRY_RAW_RETENTION_DAYS="${TELEMETRY_RAW_RETENTION_DAYS:-30}"
TELEMETRY_AGG_RETENTION_DAYS="${TELEMETRY_AGG_RETENTION_DAYS:-180}"
...
write_telemetry_env() {
  ...
  cat >"${TELEMETRY_ENV_FILE}" <<EOF
TELEMETRY_PORT=${TELEMETRY_PORT}
TELEMETRY_BIND_HOST=${TELEMETRY_BIND_HOST}
TELEMETRY_DATA_DIR=${TELEMETRY_DATA_DIR}
TELEMETRY_RAW_RETENTION_DAYS=${TELEMETRY_RAW_RETENTION_DAYS}
TELEMETRY_AGG_RETENTION_DAYS=${TELEMETRY_AGG_RETENTION_DAYS}
TELEMETRY_DASHBOARD_PATH=${TELEMETRY_DASHBOARD_PATH}
TELEMETRY_DASHBOARD_USER=${TELEMETRY_DASHBOARD_USER}
TELEMETRY_DASHBOARD_PASSWORD=${TELEMETRY_DASHBOARD_PASSWORD}
TELEMETRY_DASHBOARD_RATE_LIMIT_WINDOW_MS=${TELEMETRY_DASHBOARD_RATE_LIMIT_WINDOW_MS}
TELEMETRY_DASHBOARD_RATE_LIMIT_MAX_REQUESTS=${TELEMETRY_DASHBOARD_RATE_LIMIT_MAX_REQUESTS}
TELEMETRY_DASHBOARD_AUTH_FAIL_WINDOW_MS=${TELEMETRY_DASHBOARD_AUTH_FAIL_WINDOW_MS}
TELEMETRY_DASHBOARD_AUTH_FAIL_MAX_ATTEMPTS=${TELEMETRY_DASHBOARD_AUTH_FAIL_MAX_ATTEMPTS}
EOF
